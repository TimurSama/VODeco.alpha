...
const phases = [
  {
    ...
    milestones: [
      ...
      { title: 'User Base: 1,000-5,000', completed: false },
      { title: 'Token Launch Preparation', completed: false },
    ],
    metrics: {
      users: '1K-5K',
      regions: '1-2',
  ...
  },
  {
    ...
    status: 'planned',
    milestones: [
      { title: 'DAO Implementation', completed: false },
      { title: 'Digital Twins Development', completed: false },
      { title: 'Regional Expansion (3-5 regions)', completed: false },
      { title: 'User Base: 10,000-50,000', completed: false },
      { title: 'Token Listing (DEX)', completed: false },
    ],
    metrics: {
      users: '10K-50K',
      regions: '3-5',
  ...
  },
  {
    ...
    milestones: [
      ...
      { title: 'Infrastructure Projects', completed: false },
      { title: 'Station Construction/Modernization', completed: false },
      { title: 'Global Expansion', completed: false },
      { title: 'User Base: 100,000+', completed: false },
      { title: 'Token Listing (CEX)', completed: false },
    ],
    metrics: {
      users: '100K+',
      regions: 'Global',
